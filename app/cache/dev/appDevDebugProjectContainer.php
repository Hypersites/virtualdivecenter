...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'HypersitesClienteBundle' => 'Hypersites\\ClienteBundle\\HypersitesClienteBundle',
            ...
            'locale' => 'en',
            'secret' => '160e28e94648e10d8497929d79730e6bc',
            ...
            'kernel.secret' => '160e28e94648e10d8497929d79730e6bc',
            ...
            'braincrafted_bootstrap.customize' => array(
                'variables_file' => NULL,
                'bootstrap_output' => (dirname(dirname(__DIR__)).'/Resources/less/bootstrap.less'),
                'bootstrap_template' => 'BraincraftedBootstrapBundle:Bootstrap:bootstrap.less.twig',
            ),
            'braincrafted_bootstrap.assets_dir' => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap'),
            'braincrafted_bootstrap.fontawesome_dir' => (dirname(dirname(__DIR__)).'/../vendor/fortawesome/font-awesome'),
            'braincrafted_bootstrap.fonts_dir' => (dirname(dirname(__DIR__)).'/../web/fonts'),
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('bootstrap_css' => array(0 => array(0 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap/less/bootstrap.less'), 1 => (dirname(dirname(dirname(__DIR__))).'/vendor/braincrafted/bootstrap-bundle/Braincrafted/Bundle/BootstrapBundle/DependencyInjection/../Resources/less/form.less')), 1 => array(0 => 'less'), 2 => array('output' => 'css/bootstrap.css')), 'bootstrap_js' => array(0 => array(0 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap/js/transition.js'), 1 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap/js/alert.js'), 2 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap/js/button.js'), 3 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap/js/carousel.js'), 4 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap/js/collapse.js'), 5 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap/js/dropdown.js'), 6 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap/js/modal.js'), 7 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap/js/tooltip.js'), 8 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap/js/popover.js'), 9 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap/js/scrollspy.js'), 10 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap/js/tab.js'), 11 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap/js/affix.js'), 12 => (dirname(dirname(dirname(__DIR__))).'/vendor/braincrafted/bootstrap-bundle/Braincrafted/Bundle/BootstrapBundle/DependencyInjection/../Resources/js/bc-bootstrap-collection.js')), 1 => array(), 2 => array('output' => 'js/bootstrap.js')), 'jquery' => array(0 => array(0 => (dirname(dirname(__DIR__)).'/../vendor/jquery/jquery/jquery-1.10.2.js')), 1 => array(), 2 => array('output' => 'js/jquery.js')))), 'config');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'divecenter', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => (dirname(dirname(dirname(__DIR__))).'/src/Hypersites/ClienteBundle/Entity'))), 'Hypersites\\ClienteBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('HypersitesClienteBundle' => 'Hypersites\\ClienteBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_dd54da89d7be26e14887023404f958aa76463250c573d79a3db6976ade48dda0');
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'BraincraftedBootstrapBundle:Form:bootstrap.html.twig'), 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Hypersites/ClienteBundle/Resources/views'), 'HypersitesCliente');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('160e28e94648e10d8497929d79730e6bc');
    }
