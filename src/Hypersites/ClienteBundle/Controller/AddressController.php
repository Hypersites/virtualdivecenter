...
namespace Hypersites\ClienteBundle\Controller;
...
use Hypersites\ClienteBundle\Entity\Address;
...
class AddressController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HypersitesClienteBundle:Address')->findAll();
     ...
     * @Method("POST")
     * @Template("HypersitesClienteBundle:Address:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HypersitesClienteBundle:Address')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HypersitesClienteBundle:Address:edit.html.twig")
     */
