...
use Hypersites\TourismBundle\Entity\Destination;
use Hypersites\TourismBundle\Form\DestinationType;
...
class DestinationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HypersitesTourismBundle:Destination')->findAll();
     ...
     * @Method("POST")
     * @Template("HypersitesTourismBundle:Destination:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HypersitesTourismBundle:Destination')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HypersitesTourismBundle:Destination:edit.html.twig")
     */
