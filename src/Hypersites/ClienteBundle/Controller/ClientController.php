...
use Hypersites\ClienteBundle\Entity\Client;
use Hypersites\ClienteBundle\Form\ClientType;
...
class ClientController extends Controller
{
     ...
     * @Method("POST")
     * @Template("HypersitesClienteBundle:Client:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HypersitesClienteBundle:Client')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HypersitesClienteBundle:Client:edit.html.twig")
     */
