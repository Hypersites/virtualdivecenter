...
namespace Hypersites\Commercial\SupplierBundle\Controller;
...
use Hypersites\Commercial\SupplierBundle\Entity\Supplier;
use Hypersites\Commercial\SupplierBundle\Form\SupplierType;
...
class SupplierController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HypersitesCommercialSupplierBundle:Supplier')->findAll();
     ...
     * @Method("POST")
     * @Template("HypersitesCommercialSupplierBundle:Supplier:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HypersitesCommercialSupplierBundle:Supplier')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HypersitesCommercialSupplierBundle:Supplier:edit.html.twig")
     */
